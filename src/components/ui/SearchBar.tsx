    ...
    <div style={{ position: 'relative' }}>
      ...
      <input
        ...
        style={{
          ...
          borderRadius: '12px', padding: '10px 36px 10px 38px', fontSize: '14px',
      ...
      />
      {value && (
        <button onClick={() => onChange('')} style={{ position: 'absolute', right: '10px', top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', color: 'var(--text-muted)', cursor: 'pointer', fontSize: '16px', padding: '2px', lineHeight: 1 }}>×</button>
      )}
    </div>
  )
}
