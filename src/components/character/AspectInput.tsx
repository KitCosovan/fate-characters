...
import { aspectExamples } from '../../data/aspectExamples'
        ...
        <div>
          ...
          {showExamples && (
            <div style={{
              ...
              marginTop: '6px', animation: 'fadeUp 0.15s ease',
            }}>
              {examples.map((ex, i) => (
                <button
                  key={i}
              ...
              <p style={{
                fontSize: '10px', color: 'var(--text-muted)', margin: '2px 0 0',
                fontStyle: 'italic',
              }}>
                Нажми на пример чтобы использовать
              </p>
            </div>
          )}
        </div>
